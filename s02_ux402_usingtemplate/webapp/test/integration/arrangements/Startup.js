sap.ui.define([
	...
	return Opa5.extend("student04.com.sap.training.ux402.templateusage.ux402usingtemplate.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "student04.com.sap.training.ux402.templateusage.ux402usingtemplate",
					async: true
				},
				hash: oOptions.hash,
