		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OPA Tests",
									"targetURL": "#student04comsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student04comsaptrainingux402opaux402opa-display": {
								"semanticObject": "student04comsaptrainingux402opaux402opa",
								"action": "display",
								"description": "A OPA-test Application.",
								"title": "OPA Tests",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student04.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("student04/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
